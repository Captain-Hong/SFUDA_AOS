...
class Resnet_Unet(nn.Module):
    ...
    BN_enable控制是否存在BN，定稿设置为True
    """
    def __init__(self, resnet_pretrain=False,img_ch=1, num_classes=5):
        super().__init__()
        ...
        self.firstconv = nn.Conv2d(in_channels = img_ch, out_channels=64, kernel_size=7, stride=2, padding=3, bias=False)
